...
export default function Unique(){
    return(
        <div className="container px-10 mx-auto">
            <div className="mb-20 mt-[-50px] sm:my-20 overflow-hidden">
                <div className="flex justify-end pb-8">
                    <h1 className="font-bold text-[1.75rem] sm:text-[2.75rem] leading-[40px] pl-40 sm:leading-[55px] tracking-wide text-[#212121] w-[50%] ">Unique and Authentic Vintage Designer Jewellery</h1>
                </div>
                <div className="grid px-10 grid-cols-[50%_50%]">
                    <div className="w-full relative justify-center items-center">
                        <div className="absolute font-extrabold text-[4rem] sm:text-[6.875rem] leading-[110px] opacity-[0.07] text-[#212121] z-10">Different from others</div>
